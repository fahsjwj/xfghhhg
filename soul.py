...
TOKEN = '7440997634:AAEhf_HWJfgfJrPYyearOieJyMIX0XYgjt4'
...
FORWARD_CHANNEL_ID = -1002224125490
CHANNEL_ID = -1002224125490
error_channel_id = -1002224125490
...
def handle_message(message):
    if message.text == "Instant Plan 🧡":
        ...
        bot.send_message(message.chat.id, "*Please use the following link for Canary Download: https://t.me/MukundModz/4", parse_mode='Markdown')
